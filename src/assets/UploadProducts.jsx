...
const UploadProducts = () => {
  ...
  return (
    <div className='mt-[6.1rem] p-3'>
      <h5 className='text-[1.4rem] font-semibold text-center'>Add products</h5>
      <hr className='border-1 border-gray-600 my-1' />

      <div className='lg:flex lg:justify-between lg:gap-3 pt-5 '>
        <div className=" lg:w-[40vw]">
          ...
          <div className="mt-2 flex justify-center rounded-lg border-2 border-dashed border-gray-900/25 px-6 py-10">
            <div className="text-center">
              {imgUrl ?
                <img src={imgUrl} className="mx-auto w-full md:w-[50%]" alt="product img" />
                : <svg
        ...
        <div className="space-y-12 lg:w-[50vw]">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-6">
              ...
              <div className="col-span-full">
                ...
                <p className="mt-3 text-sm/6 text-gray-600">
                  Write a few sentences Item Description.
                </p>
              </div>
          ...
          <div className="border-b border-gray-900/10 pb-5">
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2 grid grid-cols-1">
                  <select
                    ...
                    className="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-1.5 pl-3 pr-8 text-base text-gray-900 outline outline-1 -outline-offset-1  outline-gray-500 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                  >
                    <option disabled>Select the minimum order quantity</option>
            ...
            <div className="mt-6 flex items-center justify-center gap-x-6">
              ...
              <button
                type='submit'
                className="rounded-md bg-indigo-600 px-3 py-2 w-full md:w-fit lg:w-full text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Add Products
              </button>
            </div>
