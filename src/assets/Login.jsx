                            ...
                            <div className="mt-7 sm:mx-auto sm:w-full sm:max-w-sm">
                                <form className="space-y-6" onSubmit={verifyOtp}>
                                    ...
                                    <div>
                                        ...
                                        <span className='text-sm text-gray-500'>Sent to <span className='underline'>{email}</span></span>
                                        <div className="mt-2">
                                            <input
                                                ref={inputFocus}
                                                value={otp}
                                                ...
                                                required
                                                className={`block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 ${otpError ? 'outline-red-500' : 'outline-gray-500 focus:outline-indigo-600 '} placeholder:text-gray-500 focus:outline focus:outline-2 focus:-outline-offset-2  number-input sm:text-sm/6 `}
                                            />
                                ...
                                <div className="mt-7 sm:mx-auto sm:w-full sm:max-w-sm">
                                    <form className="space-y-6" onSubmit={sendOtpFunction}>
                                        ...
                                        <div>
                                            ...
                                            <span className='text-sm text-gray-500'>Enter your email and we will send you a login code</span>
                                            <div className="mt-2">
                                                <input
                                                    value={email}
                                        ...
                                        <div>
                                            ...
                                            <button
                                                ...
                                                type="submit"
                                                className={`flex w-full justify-center rounded-md ${btnToggle ? "bg-gray-500 cursor-auto" : "bg-indigo-600 hover:bg-indigo-500"} px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
                                            >
                                                Continue
                                            </button>
                                        </div>
