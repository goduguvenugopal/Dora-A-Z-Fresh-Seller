      ...
      <div className='mt-[6.1rem] p-3 lg:p-5'>
        ...
        <div className='mb-5 relative lg:w-[450px]'>
          ...
          <div className='text-center mt-4'>
            ...
            <span onClick={() => findAdmins("admin")} className='hover:bg-blue-800 cursor-pointer px-3 p-1 m-1 rounded-full bg-blue-600 text-white w-fit'>
              Admin
            </span>
          </div>
        </div>
              ...
              <tr key={item._id} className='bg-gray-700 h-10 text-white'>
                <td className="border border-white pl-3">
                  <div className='relative flex flex-col gap-1 py-2'>
                    ...
                    <FaEdit title='Edit' onClick={() => setEditId(item._id)} size={20} className='absolute cursor-pointer right-2 hover:text-green-700' />
                    <RiDeleteBin6Line onClick={() => deleteAccount(item._id)} title='Delete' size={20} className='absolute cursor-pointer right-[2.7rem] hover:text-red-700' />
                  </div>
                </td>
      ...
      {/* edit modal section  */}
      {
        ...
        <div className='fixed  top-0 left-0 bg-gray-700 bg-opacity-75 flex h-screen w-screen items-center justify-center p-10'>
          <div className='bg-white p-3 rounded w-[300px] '>
            ...
            <select onChange={(e) => setRole(e.target.value)} value={role} className='border-2 border-blue-600 mt-3 rounded w-full h-10'>
