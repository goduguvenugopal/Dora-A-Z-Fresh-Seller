...
const Orders = () => {
  ...
  const [selectDate, setSelectDate] = useState(new Date().toLocaleDateString("en-GB"))
  const dateRef = useRef(null)


  // rendering orders according to the date 
  useEffect(() => {
    const remainTodayOrders = orders.filter((item) => item.orderDate === selectDate)
